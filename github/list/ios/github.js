...
list:[
    ...
    {name:'objection',      owner:'', desc:'一个估计是java ee写多了的人搞的。。注解依赖注入xx工厂之类的'},
    {name:'HTKit',          owner:'', desc:'一票乱七八糟的东西'},
    {name:'StringScore',    owner:'', desc:'模糊匹配字符串 查找某两个字符串的相似程度'},
    {name:'RegexKitLite',   owner:'', desc:'正则表达式库 (从SF.net mirror过来)'},
    {name:'FormatterKit',   owner:'', desc:'一套NSString的格式化工具'},
    {name:'TMCache',        owner:'', desc:'一个Cache'},
    {name:'EGOCache',       owner:'', desc:'EGOImage里面的 Cache功能'},
    {name:'HJCache',        owner:'', desc:'一个缓存网络内容等的Cache'},
    {name:'RNCryptor',      owner:'', desc:'加密解密相关 貌似更上流, note:去看一下他博客'},
    ...
    {name:'storage',        owner:'', desc:'快速、线程安全的I/O存储操作'}
]
},

{name:'框架/封装',
list:[
    {name:'three20',            owner:'', desc:'facebook的开源库 很多东西 (Deprecated)'},
    {name:'nimbus',             owner:'', desc:'three20替代品 增强型库,添加了很多默认没有的功能，挺复杂的样子'},
    {name:'BeeFramework',       owner:'', desc:'一款MVC框架 附带调试工具等'},
...
list:[
    ...
    {name:'UIDevice-with-UniqueIdentifier-for-iOS-5', owner:'', desc:'另一个UUID解决方案'},
...
list:[
    ...
    {name:'json-framework',  owner:'', desc:'SBJson 曾经用得广泛的JSON'},
...
{name:'SDK',
list:[
    {name:'facebook-ios-sdk',     owner:'', desc:'Facebook的API'},
...
list:[
    ...
    {name:'modizer',             owner:'', desc:'!!!超强大的App 可以读取和演奏各种mod音乐 midi合成 解压 下载 自带庞大音乐库~ 已上架'},
...
list:[
    ...
    {name:'Tiny-Wings-Remake-on-Android', owner:'', desc:'如题.'}
    ]
},
...
{name:'GPU OpenGL',
list:[
    {name:'GPUImage',          owner:'', desc:'很棒的GPU图像视频处理'},
...
{name:'常见动画',
list:[
    {name:'BCGenieEffect',           owner:'', desc:'和Mac里最小化的效果～～很棒~'},
    ...
    {name:'GC3DFlipTransitionStyleSegue', owner:'', desc:'用GL实现的iBook 一般'},
...
list:[
    ...
    {name:'ATMHud',                   owner:'', desc:'很棒的HUD 有阴影和动画~'},
...
list:[
    ...
    {name:'HybridRefreshGestureRecognizer', owner:'', desc:'一个类似似TweetBot的下拉刷新样式'}
    ]
},
...
list:[
    ...
    {name:'SevenSwitch',   owner:'', desc:'iOS7风格的Switch 效果很多～'}
    ]
},
...
list:[
    ...
    {name:'RNRippleTableView',         owner:'', desc:'Cell梳子抖动~ 挺有创意'}
    ]
},
...
list:[
    ...
    {name:'iOS-5-Cookbook',         owner:'', desc:'随书代码～'},
    {name:'iOS-6-Cookbook',         owner:'', desc:''},
    {name:'iOS-6-Advanced-Cookbook',owner:'', desc:''},
